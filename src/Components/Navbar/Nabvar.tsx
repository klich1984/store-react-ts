...
const Nabvar = () => {
  ...
  return (
    <nav className='flex justify-between items-center fixed -z-50 w-full px-8 py-5 text-sm font-light'>
      <ul className='flex items-center gap-3'>
        ...
        <li>
          <NavLink to='/furniture'className={({ isActive }) => isActive ? activeStyle : ''} >
            Furniture
          </NavLink>
        </li>
        <li>
